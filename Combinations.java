...
public class Combinations {
    ...
    public Combinations[] comb_set() {
        File fileToParse = new File("deep_rastr.ini");
        ...
        int i;
        Combinations[] comb = new Combinations[recombination_gammas.length * recombination_strategies.length * gamma_inits.length];
